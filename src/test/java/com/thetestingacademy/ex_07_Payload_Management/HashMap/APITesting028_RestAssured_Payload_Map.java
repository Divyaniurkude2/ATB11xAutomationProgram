...
//                "}";
        ...
        jsonBodyUsingMap.put("firstname","Divyani");
        jsonBodyUsingMap.put("lastname", "Urkude");
        ...
        validatableResponse.body("booking.firstname", Matchers.equalTo("Divyani"));
        validatableResponse.body("booking.lastname", Matchers.equalTo("Urkude"));
